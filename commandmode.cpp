...
/// @brief It handles absolute and relative paths in cmd mode
/// @param str 
/// @return 
...
/// @brief It splits input string into tokens separeted by space and stores in vector tokens 
/// @param str 
...
/// @brief It clears command line area after each command runs 
void clearCommand()
{
...
/// @brief It starts the command mode and takes input from user and process it 
